...
( () => {
            ...
            window.tram = function(a) {
                ...
                function i(a2, b2, c2) {
                    ...
                    void 0 === a2)
                        return c2;
                    var d2 = c2;
                    return $.test(a2) || !_.test(a2) ? d2 = parseInt(a2, 10) : _.test(a2) && (d2 = 1e3 * parseFloat(a2)),
                    0 > d2 && (d2 = 0),
                    d2 === d2 ? d2 : c2;
                }
                function j(a2) {
                ...
                var l = function(a2, b2, c2) {
                    ...
                    function g2(h2, i2) {
                        function j2() {
                            var a3 = new k2();
                            return e2(a3.init) && a3.init.apply(a3, arguments),
                            a3;
                        }
                        function k2() {}
                        i2 === c2 && (i2 = h2,
                        ...
                        return n2.constructor = j2,
                        j2.mixin = function(b3) {
                            return k2[a2] = j2[a2] = g2(j2, b3)[a2],
                            j2;
                        }
                        ,
                        j2.open = function(a3) {
                            if (l2 = {},
                            e2(a3) ? l2 = a3.call(j2, n2, m2, j2, h2) : d2(a3) && (l2 = a3),
                            d2(l2))
                                for (var c3 in l2)
                                    b2.call(l2, c3) && (n2[c3] = l2[c3]);
                            return e2(n2.init) || (n2.init = h2),
                            j2;
                        }
                        ,
                        j2.open(i2);
                  ...
                  , m = {
                    ...
                    "ease-in-out-back": ["cubic-bezier(0.680, -0.550, 0.265, 1.550)", function(a2, b2, c2, d2, e2) {
                        return void 0 === e2 && (e2 = 1.70158),
                        (a2 /= d2 / 2) < 1 ? c2 / 2 * a2 * a2 * (((e2 *= 1.525) + 1) * a2 - e2) + b2 : c2 / 2 * ((a2 -= 2) * a2 * (((e2 *= 1.525) + 1) * a2 + e2) + 2) + b2;
                    }
                    ]
                }
                  , n = {
                ...
                var J = b.frame = function() {
                  ...
                  , L = l(function(b2) {
                    function d2(a2, b3) {
                        ...
                        if (!b3.weak || !this.props[d3]) {
                            var f3 = e3[0]
                              , g3 = this.props[d3];
                            return g3 || (g3 = this.props[d3] = new f3.Bare()),
                    ...
                    function e2(a2, b3, c2) {
                        if (a2) {
                            var e3 = typeof a2;
                            if (b3 || (this.timer && this.timer.destroy(),
                            this.queue = [],
                            this.active = false),
                            "number" == e3 && b3)
                    ...
                    function l2(a2) {
                        ...
                        var b3;
                        "string" == typeof a2 ? (b3 = {},
                        b3[a2] = 1) : b3 = "object" == typeof a2 && null != a2 ? a2 : this.props,
                        u2.call(this, b3, v2),
                        t2.call(this);
                    }
                    function m2(a2) {
                        l2.call(this, a2),
                        u2.call(this, a2, w2, x2);
                    }
                    function n2(a2) {
                    ...
                    function u2(a2, b3, e3) {
                        ...
                        for (f3 in a2)
                            h3 = a2[f3],
                            f3 in Z ? (k2.transform || (k2.transform = {}),
                            k2.transform[f3] = h3) : (s.test(f3) && (f3 = c(f3)),
                            f3 in Y ? k2[f3] = h3 : (i2 || (i2 = {}),
                            i2[f3] = h3));
                        for (f3 in k2) {
                            if (h3 = k2[f3],
                            g3 = this.props[f3],
                    ...
                    function y2(a2, c2) {
                        b2[a2] = function() {
                            return this.children ? A2.call(this, c2, arguments) : (this.el && c2.apply(this, arguments),
                            this);
                        }
                        ;
                    }
                  ...
                  , N = l(function(a2) {
                    function b2() {
                        ...
                        this.update("auto");
                        var b3 = this.get();
                        return this.update(a3),
                        b3;
                    }
                    function c2(a3, b3, c3) {
                        return void 0 !== b3 && (c3 = b3),
                        a3 in m ? a3 : c3;
                    }
                    function d2(a3) {
                    ...
                    a2.init = function(a3, b3, d3, e2) {
                        ...
                        U.fallback || e2.fallback ? this.animate = this.fallback : (this.animate = this.transition,
                    ...
                    a2.fallback = function(a3) {
                        ...
                        a3 = this.convert(a3, this.type),
                        this.auto && ("auto" == c3 && (c3 = this.convert(this.get(), this.type)),
                        "auto" == a3 && (a3 = b2.call(this))),
                        this.tween = new R({
                            from: c3,
                            to: a3,
                    ...
                    ,
                    a2.stop = function() {
                        (this.active || this.nextStyle) && (this.active = false,
                        this.nextStyle = null,
                  ...
                  , R = l(function(b2) {
                    ...
                    b2.init = function(a2) {
                        ...
                        void 0 === d2 && (d2 = l2.to),
                        this.unit = a2.unit || "",
                        "number" == typeof c3 && "number" == typeof d2 ? (this.begin = c3,
                        this.change = d2 - c3) : this.format(d2, c3),
                    ...
                    b2.render = function(a2) {
                        ...
                        if (c3 < this.duration) {
                            ...
                            return b3 = this.startRGB ? k2(this.startRGB, this.endRGB, d2) : j2(this.begin + d2 * this.change),
                  ...
                  , S = l(R, function(a2) {
                    ...
                    a2.render = function(a3) {
                        ...
                        b2 < this.duration || (this.complete.call(this.context),
                        this.destroy());
                    }
                    ;
                })
                  , T = l(R, function(a2, b2) {
                    a2.init = function(a3) {
                        ...
                        for (b3 in a3.values)
                            c2 = a3.values[b3],
                            this.current[b3] !== c2 && this.tweens.push(new R({
                                name: b3,
        ...
        "node_modules/redux/lib/createStore.js"(exports) {
            ...
            function createStore(reducer, preloadedState, enhancer) {
                ...
                function dispatch(action) {
                    if (!(0,
                    _isPlainObject2["default"])(action)) {
            ...
            function combineReducers2(reducers) {
                ...
                for (var i = 0; i < reducerKeys.length; i++) {
                    ...
                    if (false) {
                        if (typeof reducers[key] === "undefined") {
                            (0,
                            _warning2["default"])('No reducer provided for key "' + key + '"');
                        }
                    }
                ...
                return function combination() {
                    ...
                    if (false) {
                        ...
                        if (warningMessage) {
                            (0,
                            _warning2["default"])(warningMessage);
                        }
                    }
        ...
        "packages/systems/ix2/engine/reducers/IX2SessionReducer.ts"() {
            ...
            ixSession = (state=initialState2, action) => {
                ...
                case IX2_SESSION_STARTED2:
                    {
                        return (0,
                        import_timm2.set)(state, "active", true);
                    }
                case IX2_TEST_FRAME_RENDERED2:
                    {
                        const {payload: {step=TEST_FRAME_STEPS_SIZE}} = action;
                        return (0,
                        import_timm2.set)(state, "tick", state.tick + step);
                    }
                ...
                case IX2_ANIMATION_FRAME_CHANGED2:
                    {
                        ...
                        return (0,
                        import_timm2.set)(state, "tick", now);
                    }
                case IX2_EVENT_LISTENER_ADDED2:
                    {
                        const eventListeners = (0,
                        import_timm2.addLast)(state.eventListeners, action.payload);
                        return (0,
                        import_timm2.set)(state, "eventListeners", eventListeners);
                    }
                case IX2_EVENT_STATE_CHANGED2:
                    {
                        const {stateKey, newState} = action.payload;
                        return (0,
                        import_timm2.setIn)(state, ["eventState", stateKey], newState);
                    }
                case IX2_ACTION_LIST_PLAYBACK_CHANGED2:
                    {
                        const {actionListId, isPlaying} = action.payload;
                        return (0,
                        import_timm2.setIn)(state, ["playbackState", actionListId], isPlaying);
                    }
                ...
                case IX2_MEDIA_QUERIES_DEFINED2:
                    {
                        return (0,
                        import_timm2.set)(state, "hasDefinedMediaQueries", true);
                    }
                default:
                    {
                        return state;
    ...
    var init_IX2BrowserSupport = __esm({
        "packages/systems/ix2/shared/logic/IX2BrowserSupport.ts"() {
            ...
            ELEMENT_MATCHES = withBrowser( () => {
                return (0,
                import_find.default)(["matches", "matchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector", "webkitMatchesSelector"], (key) => key in Element.prototype);
            }
            );
    ...
    var init_IX2Easings = __esm({
        "packages/systems/ix2/shared/logic/IX2Easings.ts"() {
            ...
            magicSwing = 1.70158;
            ease = (0,
            import_bezier_easing.default)(0.25, 0.1, 0.25, 1);
            easeIn = (0,
            import_bezier_easing.default)(0.42, 0, 1, 1);
            easeOut = (0,
            import_bezier_easing.default)(0, 0, 0.58, 1);
            easeInOut = (0,
            import_bezier_easing.default)(0.42, 0, 0.58, 1);
        }
    });
    ...
    function createBezierEasing(easing) {
        return (0,
        import_bezier_easing2.default)(...easing);
    }
    ...
    function createElementState(state, ref, refType, elementId, actionItem) {
        const refId = refType === PLAIN_OBJECT2 ? (0,
        import_timm3.getIn)(actionItem, ["config", "target", "objectId"]) : null;
        return (0,
        import_timm3.mergeIn)(state, [elementId], {
            id: elementId,
            ref,
            refId,
            refType
    ...
    function mergeActionState(state, elementId, actionTypeId, actionState, actionItem) {
        ...
        return (0,
        import_timm3.mergeIn)(state, mergePath, actionState, units);
    }
                ...
                case IX2_INSTANCE_ADDED2:
                    {
                        ...
                        let newState = state;
                        if ((0,
                        import_timm3.getIn)(newState, [elementId, ref]) !== ref) {
        ...
        "packages/systems/ix2/plugins/IX2Variable.js"(exports) {
            ...
            var getPluginOrigin2 = (refState2, actionItem) => {
                ...
                if (destination.red != null && destination.green != null && destination.blue != null) {
                    return (0,
                    _normalizeColor.normalizeColor)(computedValue);
                }
            }
            ;
            var getPluginDestination2 = (actionItemConfig) => {
    ...
    var require_plugins = __commonJS({
        "packages/systems/ix2/plugins/index.js"(exports) {
            ...
            var _sharedconstants = (init_shared_constants(),
            __toCommonJS(shared_constants_exports));
            var _IX2Lottie = /* @__PURE__ */
            _interop_require_wildcard(require_IX2Lottie());
            var _IX2Spline = /* @__PURE__ */
            _interop_require_wildcard(require_IX2Spline());
            var _IX2Rive = /* @__PURE__ */
            _interop_require_wildcard(require_IX2Rive());
            var _IX2Variable = /* @__PURE__ */
            _interop_require_wildcard(require_IX2Variable());
            function _getRequireWildcardCache(nodeInterop) {
                if (typeof WeakMap !== "function")
                    return null;
                var cacheBabelInterop = /* @__PURE__ */
                new WeakMap();
                var cacheNodeInterop = /* @__PURE__ */
                new WeakMap();
            ...
            var pluginMethodMap2 = /* @__PURE__ */
            new Map([[_sharedconstants.ActionTypeConsts.PLUGIN_LOTTIE, {
                ..._IX2Lottie
        ...
        "node_modules/lodash/_baseReduce.js"(exports, module) {
            function baseReduce(collection, iteratee, accumulator, initAccum, eachFunc) {
                eachFunc(collection, function(value, index, collection2) {
                    ...
                    value) : iteratee(accumulator, value, index, collection2);
                });
                return accumulator;
            }
    ...
    function reifyState({events, actionLists, site}={}) {
        const eventTypeMap = (0,
        import_reduce.default)(events, (result, event) => {
    ...
    function getInstanceOrigin(element, refState2={}, computedStyle={}, actionItem, elementApi) {
        ...
        case STYLE_OPACITY:
            return {
                value: (0,
                import_defaultTo.default)(parseFloat(getStyle2(element, OPACITY2)), 1)
            };
        case STYLE_SIZE2:
            {
                ...
                if (actionItem.config.widthUnit === AUTO2) {
                    ...
                    widthValue = (0,
                    import_defaultTo.default)(parseFloat(inlineWidth), // @ts-expect-error - TS18047 - 'computedStyle' is possibly 'null'.
                    parseFloat(computedStyle.width));
                }
                if (actionItem.config.heightUnit === AUTO2) {
                    ...
                    heightValue = (0,
                    import_defaultTo.default)(parseFloat(inlineHeight), // @ts-expect-error - TS18047 - 'computedStyle' is possibly 'null'.
                    parseFloat(computedStyle.height));
                }
                return {
                    widthValue,
        ...
        case GENERAL_DISPLAY:
            return {
                ...
                value: (0,
                import_defaultTo.default)(getStyle2(element, DISPLAY2), computedStyle.display)
            };
        case OBJECT_VALUE:
    ...
    function renderFilter(element, actionState, actionItemConfig, elementApi) {
        const filterValue = (0,
        import_reduce.default)(actionState, (result, value, type) => `${result} ${type}(${value}${getFilterUnit(type, actionItemConfig)})`, "");
        const {setStyle: setStyle2} = elementApi;
        addWillChange(element, FILTER2, elementApi);
        setStyle2(element, FILTER2, filterValue);
    }
    function renderFontVariation(element, actionState, actionItemConfig, elementApi) {
        const fontVariationValue = (0,
        import_reduce.default)(actionState, (result, value, type) => {
    ...
    function parseColor({element, actionTypeId, computedStyle, getStyle: getStyle2}) {
        ...
        return {
            ...
            rValue: (0,
            import_defaultTo.default)(parseInt(matches[0], 10), 255),
            // @ts-expect-error - TS2345 - Argument of type 'string | undefined' is not assignable to parameter of type 'string'.
            gValue: (0,
            import_defaultTo.default)(parseInt(matches[1], 10), 255),
            // @ts-expect-error - TS2345 - Argument of type 'string | undefined' is not assignable to parameter of type 'string'.
            bValue: (0,
            import_defaultTo.default)(parseInt(matches[2], 10), 255),
            // @ts-expect-error - TS2345 - Argument of type 'string | undefined' is not assignable to parameter of type 'string'.
            aValue: (0,
            import_defaultTo.default)(parseFloat(matches[3]), 1)
        };
    }
    ...
    function reduceListToGroup({actionList, actionItemId, rawData}) {
        ...
        const takeItemUntilMatch = (actionItem) => {
            ...
            import_timm4.mergeIn)(actionItem, ["config"], {
                delay: 0,
                duration: 0
            }));
        ...
        "packages/systems/ix2/shared/logic/IX2VanillaUtils.ts"() {
            ...
            getItemConfigByKey = (actionTypeId, key, config) => {
                ...
                case STYLE_FILTER2:
                    {
                        const filter = (0,
                        import_findLast.default)(config.filters, ({type}) => type === key);
                        return filter ? filter.value : 0;
                    }
                case STYLE_FONT_VARIATION2:
                    {
                        const fontVariation = (0,
                        import_findLast.default)(config.fontVariations, ({type}) => type === key);
            ...
            getFilterUnit = (filterType, actionItemConfig) => {
                const filter = (0,
                import_findLast.default)(actionItemConfig.filters, ({type}) => type === filterType);
            ...
            processElementByType = ({effect, actionTypeId, elementApi}) => (// @ts-expect-error - TS7006 - Parameter 'element' implicitly has an 'any' type.
            (element) => {
                switch (actionTypeId) {
                case TRANSFORM_MOVE2:
                case TRANSFORM_SCALE2:
    ...
    var require_shared = __commonJS({
        "packages/systems/ix2/shared/index.js"(exports) {
            ...
            var _IX2BrowserSupport = /* @__PURE__ */
            _interop_require_wildcard((init_IX2BrowserSupport(),
            __toCommonJS(IX2BrowserSupport_exports)));
            var _IX2Easings = /* @__PURE__ */
            _interop_require_wildcard((init_IX2Easings(),
            __toCommonJS(IX2Easings_exports)));
            var _IX2EasingUtils = /* @__PURE__ */
            _interop_require_wildcard((init_IX2EasingUtils(),
            __toCommonJS(IX2EasingUtils_exports)));
            var _IX2ElementsReducer = /* @__PURE__ */
            _interop_require_wildcard((init_IX2ElementsReducer(),
            __toCommonJS(IX2ElementsReducer_exports)));
            var _IX2VanillaPlugins = /* @__PURE__ */
            _interop_require_wildcard((init_IX2VanillaPlugins(),
            __toCommonJS(IX2VanillaPlugins_exports)));
            var _IX2VanillaUtils = /* @__PURE__ */
            _interop_require_wildcard((init_IX2VanillaUtils(),
            __toCommonJS(IX2VanillaUtils_exports)));
            function _getRequireWildcardCache(nodeInterop) {
                if (typeof WeakMap !== "function")
                    return null;
                var cacheBabelInterop = /* @__PURE__ */
            ...
            timedInstance = (state, action) => {
                ...
                if (active && origin) {
                    ...
                    if (verbose) {
                        ...
                        state = (0,
                        import_timm5.set)(state, "verboseTimeElapsed", verboseDuration * verbosePosition);
                    }
                    if (delta < 0) {
                        return state;
                    }
                    ...
                    return (0,
                    import_timm5.merge)(state, newProps);
                }
                return state;
            }
            ;
                ...
                case IX2_INSTANCE_ADDED3:
                    {
                        ...
                        return (0,
                        import_timm5.set)(state, instanceId, {
                            id: instanceId,
                            elementId,
                            active: false,
                            position: 0,
                ...
                case IX2_INSTANCE_STARTED2:
                    {
                        ...
                        return (0,
                        import_timm5.mergeIn)(state, [instanceId], {
                            active: true,
                            complete: false,
                            start: time
                        });
                ...
                case IX2_ANIMATION_FRAME_CHANGED3:
                    {
                        ...
                        for (let i = 0; i < length; i++) {
                            ...
                            newState = (0,
                            import_timm5.set)(newState, key, reducer(instance, action));
                        }
                        return newState;
                    }
                default:
    ...
    var init_IX2ParametersReducer = __esm({
        "packages/systems/ix2/engine/reducers/IX2ParametersReducer.ts"() {
            ...
            ixParameters = (state={/*mutable flat state*/
            }, action) => {
                switch (action.type) {
    ...
    var init_IX2Reducer = __esm({
        "packages/systems/ix2/engine/reducers/IX2Reducer.ts"() {
            ...
            IX2Reducer_default = (0,
            import_redux.combineReducers)({
                ixData,
                ixRequest,
                ixSession,
    ...
    var init_IX2VanillaEvents = __esm({
        "packages/systems/ix2/engine/logic/IX2VanillaEvents.ts"() {
            ...
            isOrContainsElement = (0,
            import_flow.default)([isElement, containsElement]);
            ...
            actionGroupCreator = ({store, event, element, eventStateKey}, state) => {
                ...
                if (eventToStop) {
                    stopActionGroup({
                        ...
                        actionListId: (0,
                        import_get.default)(eventToStop, "action.config.actionListId")
                    });
                }
                stopActionGroup({
                    store,
            ...
            getDocumentState = ( () => {
                ...
                return () => ({
                    ...
                    stiffScrollTop: (0,
                    import_clamp.default)(supportOffset ? window.pageYOffset : rootElement.scrollTop, 0, rootElement.scrollHeight - window.innerHeight),
    ...
    function handlePlaybackRequest(playback, store) {
        ...
        if (actionListId && actionTypeId === ActionTypeConsts.GENERAL_START_ACTION || isQuickEffect(actionTypeId)) {
            ...
            if (verbose && started) {
                store.dispatch(actionListPlaybackChanged({
                    actionListId,
                    isPlaying: !immediate
                }));
            }
    ...
    restingValue}) {
        ...
        instanceConfigs.forEach( ({element, key}) => {
            ...
            const actionItem = (0,
            import_get2.default)(actionGroups, `[0].actionItems[0]`, {});
            const {actionTypeId} = actionItem;
    ...
    function bindEvents(store) {
        ...
        (0,
        import_forEach.default)(eventTypeMap, (events, key) => {
    ...
    function bindEventType({logic, store, events}) {
        ...
        if (!(0,
        import_size.default)(eventTargets)) {
            return;
        }
        (0,
        import_forEach.default)(eventTargets, (elements, key) => {
            ...
            if (eventAction.actionTypeId === ActionTypeConsts.GENERAL_CONTINUOUS_ACTION) {
                ...
                configs.forEach( (eventConfig) => {
                    ...
                    const paramGroups = (0,
                    import_get2.default)(actionLists, `${actionListId}.continuousParameterGroups`, []);
                    const parameterGroup = (0,
                    import_find2.default)(paramGroups, ({id}) => id === continuousParameterGroupId);
        ...
        ;
        const handleEventThrottled = (0,
        import_throttle.default)(handleEvent, THROTTLED_EVENT_WAIT);
    ...
    function renderInitialGroup({store, actionListId, eventId}) {
        ...
        if (actionList && actionList.useFirstGroupAsInitialState) {
            const initialStateItems = (0,
            import_get2.default)(actionList, "actionItemGroups[0].actionItems", []);
            const mediaQueries = (0,
            import_get2.default)(event, "mediaQueries", ixData2.mediaQueryKeys);
            if (!shouldAllowMediaQuery2(mediaQueries, ixSession2.mediaQueryKey)) {
                return;
            }
            initialStateItems.forEach( (actionItem) => {
                ...
                itemConfig?.target?.objectId == null ? (// @ts-expect-error - TS18048 - 'event' is possibly 'undefined'.
                {
                    target: event.target,
    ...
    function stopAllActionGroups({store}) {
        ...
        (0,
        import_forEach.default)(ixInstances2, (instance) => {
    ...
    actionListId}) {
        ...
        (0,
        import_forEach.default)(ixInstances2, (instance) => {
            const boundaryMode = (0,
            import_get2.default)(instance, "actionItem.config.target.boundaryMode");
    ...
    verbose}) {
        ...
        const actionList = (0,
        import_get2.default)(ixData2, `actionLists.${actionListId}`, {});
        const {actionItemGroups, useFirstGroupAsInitialState} = actionList;
        if (!actionItemGroups || !actionItemGroups.length) {
            return false;
        }
        if (groupIndex >= actionItemGroups.length && (0,
        import_get2.default)(event, "config.loop")) {
            groupIndex = 0;
        }
        ...
        const actionItems = (0,
        import_get2.default)(actionItemGroups, [groupIndex, "actionItems"], []);
    ...
    var init_IX2VanillaEngine = __esm({
        "packages/systems/ix2/engine/logic/IX2VanillaEngine.ts"() {
            ...
            mapFoundValues = (object, iteratee) => (0,
            import_omitBy.default)((0,
            import_mapValues.default)(object, iteratee), import_isEmpty.default);
            forEachEventTarget = (eventTargets, eventCallback) => {
                (0,
                import_forEach.default)(eventTargets, (elements, eventId) => {
    ...
    var require_engine = __commonJS({
        "packages/systems/ix2/engine/index.js"(exports) {
            ...
            var _IX2Reducer = /* @__PURE__ */
            _interop_require_default((init_IX2Reducer(),
            __toCommonJS(IX2Reducer_exports)));
            var _IX2VanillaEngine = (init_IX2VanillaEngine(),
            __toCommonJS(IX2VanillaEngine_exports));
            var _IX2EngineActions = /* @__PURE__ */
            _interop_require_wildcard((init_IX2EngineActions(),
...
Webflow.require('ix2').init({
    "events": {
        "e": {
            ...
            "target": {
                "id": "650072129cee9d12dcbdb778|44f5b033-42a1-cc26-e0bb-3822079df41d",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-5": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "650072129cee9d12dcbdb778|a5b1f872-5e40-2c70-388a-5418f3dddd22",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-6": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "650072129cee9d12dcbdb778|a5b1f872-5e40-2c70-388a-5418f3dddd24",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-8": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "650072129cee9d12dcbdb778|a5b1f872-5e40-2c70-388a-5418f3dddd2a",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-10": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "650072129cee9d12dcbdb778|a5b1f872-5e40-2c70-388a-5418f3dddd37",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-14": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "650072129cee9d12dcbdb778|1dd4f605-5d64-6013-57bd-53d67102a55c",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-16": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "65195d404f90a63cf71d7a23|187883cc-8f7b-c778-b59e-aeacf628a0ec",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-17": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "65195d404f90a63cf71d7a23|187883cc-8f7b-c778-b59e-aeacf628a0ef",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-19": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "65195d404f90a63cf71d7a23|187883cc-8f7b-c778-b59e-aeacf628a0fb",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-21": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "65195d404f90a63cf71d7a23|187883cc-8f7b-c778-b59e-aeacf628a107",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-23": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "65195d404f90a63cf71d7a23|187883cc-8f7b-c778-b59e-aeacf628a113",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-25": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "65195d404f90a63cf71d7a23|187883cc-8f7b-c778-b59e-aeacf628a11f",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-27": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "65195d404f90a63cf71d7a23|44b0e200-709c-3472-c0d7-9c3b56a100fd",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-29": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "6519659a763c14eba4144ed0|fa0d376a-0a11-5b76-0488-c95521206342",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-31": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "6519659a763c14eba4144ed0|fa0d376a-0a11-5b76-0488-c9552120634e",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-33": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "6519659a763c14eba4144ed0|fa0d376a-0a11-5b76-0488-c9552120635a",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-35": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "6519659a763c14eba4144ed0|fa0d376a-0a11-5b76-0488-c95521206366",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-37": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "6519659a763c14eba4144ed0|fa0d376a-0a11-5b76-0488-c95521206372",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-41": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "6519659a763c14eba4144ed0|5ba048e8-c477-be4b-028a-d375fecf267f",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-43": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "6519659a763c14eba4144ed0|6bca283d-ebd1-9f09-6efd-e1771d6423bf",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-45": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "6519659a763c14eba4144ed0|f8161a57-c9a7-dad7-8a28-f1ea70397781",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-51": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "6519659a763c14eba4144ed0|88d7c9cb-9fdd-b901-8400-fdad4e6288d7",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-55": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "6519659a763c14eba4144ed0|7240fe52-a234-40aa-3345-97f545979b04",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-61": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "65d4864ba4c45d5499fa0983|44f5b033-42a1-cc26-e0bb-3822079df41d",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-65": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "65d4864ba4c45d5499fa0983|a5b1f872-5e40-2c70-388a-5418f3dddd22",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-66": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "65d4864ba4c45d5499fa0983|a5b1f872-5e40-2c70-388a-5418f3dddd24",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-68": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "65d4864ba4c45d5499fa0983|a5b1f872-5e40-2c70-388a-5418f3dddd2a",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-70": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "65d4864ba4c45d5499fa0983|a5b1f872-5e40-2c70-388a-5418f3dddd37",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-72": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "65d4864ba4c45d5499fa0983|1dd4f605-5d64-6013-57bd-53d67102a55c",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-74": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66df3d17478b9129101a7fc8|187883cc-8f7b-c778-b59e-aeacf628a0ec",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-75": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66df3d17478b9129101a7fc8|187883cc-8f7b-c778-b59e-aeacf628a0ef",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-77": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66df3d17478b9129101a7fc8|187883cc-8f7b-c778-b59e-aeacf628a0fb",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-79": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66df3d17478b9129101a7fc8|187883cc-8f7b-c778-b59e-aeacf628a107",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-81": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66df3d17478b9129101a7fc8|187883cc-8f7b-c778-b59e-aeacf628a113",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-83": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66df3d17478b9129101a7fc8|187883cc-8f7b-c778-b59e-aeacf628a11f",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-85": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66faa97144eefcc0ffc28d13|187883cc-8f7b-c778-b59e-aeacf628a0ec",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-86": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66faa97144eefcc0ffc28d13|718cbc0e-b7b3-4cee-0948-5ad64d64b760",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
    ...
    "actionLists": {
        ...
        "a-13": {
            "id": "a-13",
            "title": "BRIX - Logo Strip V6 Animations",
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "65195d404f90a63cf71d7a23|187883cc-8f7b-c778-b59e-aeacf628a0ee"
                            },
                            "heightValue": 0,
                            "widthUnit": "PX",
                            "heightUnit": "%",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["2923641a-2f9a-b634-62ac-6216e23e85e1"]
                        },
                        "widthValue": 0,
                        "widthUnit": "%",
                        "heightUnit": "PX",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["3661ed4c-3a31-fecc-707b-ea64140c6044"]
                        },
                        "heightValue": 0,
                        "widthUnit": "PX",
                        "heightUnit": "px",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["3661ed4c-3a31-fecc-707b-ea64140c6045"]
                        },
                        "zValue": 90,
                        "xUnit": "DEG",
                        "yUnit": "DEG",
        ...
        "a-40": {
            "id": "a-40",
            "title": "BRIX - Logo Strip V6 Animations 2",
            "continuousParameterGroups": [{
                "id": "a-40-p",
                "type": "SCROLL_PROGRESS",
                "parameterLabel": "Scroll",
        ...
        "a-41": {
            "id": "a-41",
            "title": "layout32 timeline -> SCROLL 3",
            "continuousParameterGroups": [{
                "id": "a-41-p",
                "type": "SCROLL_PROGRESS",
                "parameterLabel": "Scroll",
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "66df3d17478b9129101a7fc8|187883cc-8f7b-c778-b59e-aeacf628a0ee"
                            },
                            "heightValue": 0,
                            "widthUnit": "PX",
                            "heightUnit": "%",
        ...
        "a-42": {
            "id": "a-42",
            "title": "layout32 timeline -> SCROLL 4",
            "continuousParameterGroups": [{
                "id": "a-42-p",
                "type": "SCROLL_PROGRESS",
                "parameterLabel": "Scroll",
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "66faa97144eefcc0ffc28d13|187883cc-8f7b-c778-b59e-aeacf628a0ee"
                            },
                            "heightValue": 0,
                            "widthUnit": "PX",
                            "heightUnit": "%",
